...
/* THESIS: A student can judge one room without losing their school search.
   OWN-WORLD: Inherit rentMe's Kantumruy type, blue controls and quiet neutrals.
        ...
        <article className="rental-detail-shell">
            ...
            {rental.institution && rental.distanceMeters !== null ? (
              <p>
                <strong>
                  ...
                  from{" "}
                  {rental.institution.shortName ?? rental.institution.nameEn}
                </strong>{" "}
          ...
          <div className="rental-detail-grid">
            ...
            >
              ...
              <p className="rental-detail-muted">
                Confirm availability, utility charges, and deposit terms with
                the landlord before arranging a viewing.
              </p>
            ...
            <div className="rental-detail-sections">
              ...
              <section aria-labelledby="rental-location">
                ...
                {rental.institution ? (
                  ...
                  <p>
                    Select an institution in search to see its distance from
                    this rental.
                  </p>
                )}
