    ...
    <Localized>
      <section className="dashboard-intro" aria-labelledby="dashboard-title">
        <div className="dashboard-intro-copy">
          ...
          <p>
            Keep room availability accurate and follow new student inquiries.
          </p>
        </div>
...
function RentalDashboardCard({
  ...
  const status = getListingStatusPresentation(
    listing.status,
    listing.availabilityFreshness,
  );
  ...
  const reminder = availabilityReminder(listing);
      ...
      <article className="dashboard-rental-card">
        ...
        <div className="dashboard-rental-body">
          ...
          <div className="dashboard-rental-management">
            <form onSubmit={submitAvailability} noValidate aria-busy={busy}>
              {reminder ? (
                <p
                  className="dashboard-availability-reminder"
                  id={`availability-reminder-${listing.id}`}
                >
                  {reminder}
                </p>
              ) : null}
              ...
              <div className="dashboard-availability-row">
                <input
                  ...
                  aria-describedby={`availability-help-${listing.id}${reminder ? ` availability-reminder-${listing.id}` : ""}`}
                  aria-invalid={
                    availabilityChanged && Boolean(availabilityError)
                  }
                  onChange={(event) => {
              ...
              <p id={`availability-help-${listing.id}`}>
                {availabilityChanged && availabilityError
                  ...
                  : `${formatAvailabilityFreshness(
                      ...
                      canIncreaseAvailability
                        ? " Confirm at least every 14 days."
